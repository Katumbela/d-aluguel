...
const Banner = () => {
  ...
  const filteredEquipements = cursos.filter(curso => curso.nome.toString().toLowerCase().indexOf(searchTerm.toString().toLowerCase()) !== -1);
      ...
      <div className="banner">
        ...
        <div className="input-search">
          <div className="input-form">
            ...
            <input type="search" name="" value={searchTerm} onChange={handleSearchInputChange} placeholder='O que procura ?' id="pesquisar" />
          </div>
        </div>
      </div>
      <br />
        ...
        <div className="row">
          <div className="col-12 col-md-4 col-xl-3 col-xxl-2 pt-1">
            <div className="shadow-md card-opt p-3">
              <button onClick={() => listarTudo()} className="btn btn-primary w-100">Listar tudo</button>

              <button className="btn my-3 btn-secondary w-100">Ver por Categoria</button>
              <br />
              <b>Distância</b>
              <div className="search-by">
                <label htmlFor="d" className="">Buscar por endereço</label>
          ...
          <div className="col-12 container-xxl container-fluid col-md-8 col-xl-9 col-xxl-10">
            ...
            {filteredEquipements == 0 && <center><span className='mx-auto text-secondary'>Não foi encontrado um outro resultado para o que procura!</span></center>}
